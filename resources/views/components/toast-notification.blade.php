<div id="toast" class="absolute top-8 right-8 z-50">
    <div class="max-w-xs bg-green-600 text-sm text-white rounded-md shadow-lg dark:bg-gray-900 mb-3 ml-3" role="alert">
        <div class="flex p-4">
            ...
            <div class="ml-auto px-1">
                <button type="button"
                    ...
                    <svg class="w-3.5 h-3.5 self-center" width="12" height="12" viewBox="0 0 16 16"
