...
@section('content')
    ...
    <section class="bg-white shadow-lg rounded-md max-w-max p-6 my-4 mx-auto  max-lg:mt-14">
        <div class="p-4">
            <h1 class="font-bold text-3xl pb-2">Edit procedure for {{ $procedure->name }}</h1>
        </div>
                ...
                <div class="w-full ">
                    ...
                    <label class="flex flex-col flex-1 min-w-[45%] pb-3" for="name">
                        ...
                        <input
                            ...
                            name="name" type="text" id="name" autocomplete="off" value="{{ $procedure->name }}"
                    ...
                    <label class="flex flex-col flex-1 min-w-[45%] pb-3" for="price">
                        ...
                        <input
                            ...
                            value="{{ $procedure->price }}" oninput="validateInput('price')">
                        @error('price')
                            <span id="price_error"
                                class="validation-message text-white max-md:text-sm bg-red-600 p-1 rounded-md my-1 show">{{ $message }}</span>
                        @enderror
                    ...
                    <label class="flex flex-col flex-1 min-w-[45%] pb-3" for="description">
                        ...
                        <textarea class="border max-md:text-xs flex-grow min-w-max border-gray-400 py-2 px-4 rounded-md" id="description"
                            name="description" required>{{ $procedure->description }}</textarea>
                    </label>
                </div>
