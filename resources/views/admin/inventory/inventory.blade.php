        ...
        <table class="w-full table-auto mb-2 overflow-hidden">
            <thead>
                <tr class="bg-green-200 text-green-700">
                    ...
                    <th class="border px-4 py-2 max-md:py-1 max-md:px-2 max-md:text-xs max-lg:hidden">Quantity</th>
            ...
            <tbody class="text-center">
                @foreach ($items as $item)
                    <tr class="border-b-2">
                        ...
                        <td class=" px-4 py-2 max-md:py-1 max-md:px-2 max-md:text-xs max-lg:hidden">{{ $item->quantity }}
                        </td>
                                ...
                                <div class="flex self-start max-md:text-xs ">
                                    <div
                                        ...
                                        <button class="  text-xs text-gray-700 text-center"
                                            onclick="document.getElementById('delete_modal_{{ $item->id }}').showModal()">Delete</button>
                                    </div>
