...
@section('content')
    ...
    <section class="bg-white shadow-lg rounded-md p-6 my-4 mx-2  max-lg:mt-14">
        <h1 class="font-bold text-3xl p-4">Declined Appointments</h1>
        ...
        @if ($declinedAppointments->isEmpty())
            <div class="flex gap-4 flex-col justify-center items-center py-12 ">
                ...
                <div class="flex flex-col justify-center items-center gap-2  ">
                    <h1 class="font-bold text-3xl text-center">No declined appointments right now.</h1>
                    <h1 class="text-sm text-center"> All caught up! There are no declined appointments at the moment.</h1>
                </div>
            </div>
        @else
